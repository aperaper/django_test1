...
class LoginUnsafeView(View):
    ...
    def post(self, request):
        ...
        import MySQLdb
        conn = MySQLdb.connect(host='127.0.0.1', user='root', passwd='Lovesong', db='mxonline', charset='utf8')
        cursor = conn.cursor()
        sql_select = 'select * from users_userprofile where email="{0}" and password="{}"'.format(user_name, pass_word)
